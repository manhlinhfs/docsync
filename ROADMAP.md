...
This roadmap is version-first, not date-first. `docsync` is currently stable at `v1.3.1`.
...
## Milestones after `v1.3.1`

Development after `v1.3.1` should move in milestone order unless a regression, release blocker, or security issue needs to interrupt the sequence.
